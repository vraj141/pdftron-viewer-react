    ...
    (function (c) {
        ...
        d.t = function (a, b) {
            ...
            if (b & 2 && "string" != typeof a)
                for (var e in a) d.d(c, e, function (b) {
                    return a[b]
                }.bind(null, e));
            return c
        };
        ...
        c = function (a) {
            var b = {};
            decodeURIComponent(a.slice(1)).split("&").forEach(function (a) {
                a =
                    a.split("=", 2);
                b[a[0]] = a[1]
            });
        ...
        c.path && (self.workerBasePath = c.path, self.pdfWorkerPath = "".concat(c.path, "pdf/"), self.officeWorkerPath = "".concat(c.path, "office/"));
